...
# 例如：TJ Effect/
# 特效類 Shader <英文名稱&gt.shader # 例如：TJParticleDissolve.shader
Shader/ # Shader档根據製作人姓名來存放 <製作人員>/

# Script 档根據製作人姓名來存放 <製作人員> /
# 例如：Xueyuan Effect/ # 特效類 Script <英文名稱&gt.cs # 例如： ScrollUV2.cs
Script/